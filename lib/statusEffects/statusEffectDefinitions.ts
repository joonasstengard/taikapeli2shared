...
export const STATUS_EFFECTS: StatusEffect[] = [
  ...
  {
    key: STATUS_EFFECT_KEY.transformSkarWolf,
    name: "Skar Wolf Form",
    tags: ["transform"],
    hideBadge: true,
  },
  {
    key: STATUS_EFFECT_KEY.transformThalenStag,
    name: "Thalen Stag Form",
    tags: ["transform"],
    hideBadge: true,
  },
  {
    key: STATUS_EFFECT_KEY.transformAeronorBear,
    name: "Aeronor Bear Form",
    tags: ["transform"],
    hideBadge: true,
  },
];
