...
export const WAR_CHEST_STARTING_GOLD_BONUS = 15;
...
export const RESILIENT_NATION_HEALTH_LOSS_REDUCTION = 5;

/** Faith bonus granted to warriors when recruited with Light In The Darkness. */
export const LIGHT_IN_THE_DARKNESS_RECRUIT_FAITH_BONUS = 2;

/** Speed bonus granted to warriors when recruited with Umbral Grace. */
export const UMBRAL_GRACE_RECRUIT_SPEED_BONUS = 2;
